...
VOICE_POLICY_V1: dict[str, VoicePolicyRule] = {
    ...
    "timer_add": VoicePolicyRule(),
    "timer_pause": VoicePolicyRule(),
    "timer_resume": VoicePolicyRule(),
    "timer_stop": VoicePolicyRule(),
    "memo_add": VoicePolicyRule(),
    "memo_delete": VoicePolicyRule(),
    "memo_update": VoicePolicyRule(),
    "memo_clear_all": VoicePolicyRule(require_confirm=True),
