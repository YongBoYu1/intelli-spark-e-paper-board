...
try:
    ...
    draw.text((150, 0), 'Waveshare', font = font24, fill = 0)
    ...
    # draw.text((20, 50), 'Waveshare', font = font18, fill = 0)
    ...
    # draw = ImageDraw.Draw(Limage)
    # draw.text((20, 0), 'Waveshare', font = font35, fill = epd.GRAY1)
    # draw.text((20, 35), 'Waveshare', font = font35, fill = epd.GRAY2)
    # draw.text((20, 70), 'Waveshare', font = font35, fill = epd.GRAY3)
